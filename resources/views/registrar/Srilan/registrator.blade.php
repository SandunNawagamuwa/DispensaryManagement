            ...
            <div class="col-md-3 col-sm-4 col-xs-12"></div>
             <div class="col-md-6 col-sm-4 col-xs-12">
                ...
                <form class="form-container" method="POST" action="/patient/store">
                    @csrf 
                    <h2>Patient Registration &nbsp<i class="fa fa-id-card" style="color:black"></i></h2>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="civil_status" type="text" class="form-control @error('civil_status') is-invalid @enderror" name="civil_status" value="{{ old('civil_status') }}" required autocomplete="civil_status">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="bday" type="text" class="form-control @error('bday') is-invalid @enderror" name="bday" value="{{ old('bday') }}" required autocomplete="bday">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="numberof_child" type="text" class="form-control @error('numberof_child') is-invalid @enderror" name="numberof_child" value="{{ old('numberof_child') }}" required autocomplete="numberof_child">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="allergies" type="text" class="form-control @error('allergies') is-invalid @enderror" name="allergies" value="{{ old('allergies') }}" required autocomplete="allergies">
