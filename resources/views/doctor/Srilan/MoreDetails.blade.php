    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
       ...
       <!-- <a class="navbar-brand" href="#">--><img src="img/h1.jpg" style="width:120px; height:30px"><!--!</a>-->
            ...
            <ul class="navbar-nav ml-auto my-2 my-lg-0">
                    <li class="nav-item ">
                     <a class="nav-link js-scroll-trigger" href="/U">
                     <i class='fa fa-home' style="color:yellow"></i>&nbsp Update</a>
                     </li>

            <ul class="navbar-nav ml-auto my-2 my-lg-0">
                      <li class="nav-item ">
                       <a class="nav-link js-scroll-trigger" href="/patient/index">
                       <i class='fa fa-home' style="color:yellow"></i>&nbsp Patient Details</a>
                       </li>
    ...
    <table class="table table-hover table-success">
        ...
        <tbody>
          ...
          <th scope="row">{{ $task->id }}</th>
            <td>{{$task->rate}} mg/dl</td>
            <td>{{$task->created_at}}</td>
            <td>
              <!--delete & edit-->
              <a href="/deletetask/{{$task->id}}" class="btn btn-outline-danger remove">Delete</a>
              <a href="/updatetask/{{$task->id}}" class="btn btn-success">Edit</a>
            </td>
          </tr>
          <tr>
        @endforeach   
...
&nbsp;&nbsp;
    ...
    <table class="table table-hover table-success">
      @csrf
        ...
        <tbody>
          @isset($preasures)
          @foreach($preasures as $preasure)
          <tr>
            <th scope="row">{{ $preasure->id }}</th>
            <td>{{$preasure->lower_rate}}-{{$preasure->upper_rate}} mmHg</td>
            <td>{{$preasure->created_at}}</td>
            <td>
              <!--delete & edit-->
              <a href="/delpre/{{$preasure->id}}" class="btn btn-outline-danger remove">Delete</a>
              <a href="/updatetask/{{$preasure->id}}" class="btn btn-success">Edit</a>
...
&nbsp;&nbsp;
    ...
    <table class="table table-hover table-success">
        ...
        <tbody>
          @isset($collestrols)
          @foreach($collestrols as $collestrol)
          <tr>
            <th scope="row">{{ $collestrol->id }}</th>
            <td>{{$collestrol->rate}}</td>
            <td>{{$collestrol->created_at}}</td>
            <td>
              <!--delete & edit-->
              <a href="/delcol/{{$collestrol->id}}" class="btn btn-outline-danger remove">Delete</a>
              <a href="/updatetask/{{$collestrol->id}}" class="btn btn-success">Edit</a>
            </td>
          </tr>
          <tr>
            @endforeach
