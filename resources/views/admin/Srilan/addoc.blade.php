...
<html>
  ...
  <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
             ...
             <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item ">
                            ...
                            <i class='fa fa-home' style="color:yellow"></i><b>Add Doctor</b></a>
                        </li>
                        ...
                        <li class="nav-item ">
                            ...
                            <i class='fa fa-home' style="color:yellow"></i>Add Registrar</a>
                        </li>
    ...
    <div class="row">
        ...
        <form class="form-container" method="POST" action="/doctor/store">
            @csrf
                <h2>Registor Doctor &nbsp<i class="fas fa-chalkboard-teacher" style="color:black"></i></h2>       
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="specialized_field" type="text" class="form-control @error('specialized_field') is-invalid @enderror" name="specialized_field" value="{{ old('specialized_field') }}" required autocomplete="specialized_field">
