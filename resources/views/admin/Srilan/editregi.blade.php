...
<html>
  ...
  <div class="row">
    ...
    <div class="col-md-6 col-sm-4 col-xs-12">
        <center>
        <h2>Edit Registrator &nbsp<i class="fas fa-chalkboard-teacher" style="color:black"></i></h2>
        <form class="form-container" method="POST" action="/registrar/update">
             @csrf
             @method('PUT')
            <input type="hidden" name="id" value="{{$user->id}}">
            <input type="hidden" name="user_id" value="{{$user->user_id}}">
            <h2>Edit Registrar &nbsp<i class="fa fa-id-card" style="color:black"></i></h2>
            ...
            <div class="form-check">
                ...
                <div class="col-md-6">
                     @if($user->gender=='male')
                        <input id="male" type="radio" class="form-control @error('gender') is-invalid @enderror" name="gender" value="{{ old('male') }}" required autocomplete="gender" checked>
                    ...
                    @elseif($user->gender=='female')
                        ...
                        <input id="female" type="radio" class="form-control @error('gender') is-invalid @enderror" name="gender" value="{{ old('female') }}" required autocomplete="gender" checked>
                        <label for="female" class="col-md-4 col-form-label text-md-right">{{ __('Female') }}</label>
                    @endif
                    @error('contact')
                    <span class="invalid-feedback" role="alert">
